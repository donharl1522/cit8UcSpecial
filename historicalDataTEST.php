...
<!--******SORTING TABLE STARTS HERE-->
              ...
              <table class="table align-middle mb-0 bg-white">
                  ...
                  <tbody>
                    ...
                    if(isset($_POST['search'])){
                      ...
                      if((isset($_POST['cropNameSelect'])) == "others"){
                        if(isset($_POST['fromYear']) && isset($_POST['toYear']) && isset($_POST['cropSearchBar'])){
                        $yearSearchedFrom = $_POST['fromYear'];
                        $yearSearchedTo = $_POST['toYear'];
                        $cropSearched = $_POST['cropSearchBar'];
  ...
  <script>
    document.getElementById("cropSearchBar").style.display = "none";
      function yesnoCheck(that) {
        if (that.value == "other") {
          //alert("check");
          document.getElementById("cropSearchBar").style.display = "block";
        } else {
          document.getElementById("cropSearchBar").style.display = "none";
        }
      }
