    ...
    <div class="row gx-5">
      <div class="col-md-6 mb-4">
        <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
          <img src="https://wallpaper.dog/large/20474685.jpg" class="img-fluid" />
          <a href="#!">
      ...
      <div class="col-md-6 mb-4">
        <span class="badge background-color-accent px-2 py-1 shadow-1-strong mb-3">News of the day</span>
        ...
        <button type="button" class="btn background-color-primary text-white">Read more</button>
      </div>
    </div>
  </section>
  <!--Section: News of the day-->
        ...
        <div>
          ...
          <a href="" class="text-dark">
            <div class="row mb-4 border-bottom pb-2">
              <div class="col-3">
                <img src="https://wallpaper.dog/large/20474685.jpg"
