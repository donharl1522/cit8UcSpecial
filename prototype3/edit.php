                ...
                <div class="card-body">
                    ...
                    <form action="" name="form1" method="post">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="cropName" placeholder="Enter Crop Name" name="cropName" value="<?php echo $cropName; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="cropProd" placeholder="Enter Production value" name="cropProd"  value="<?php echo $cropProd; ?>">
                      </div>
                      <div class="form-group">
                          <label for="prodRate">Productivity:</label>
                          <input type="text" class="form-control" id="prodRate" placeholder="Enter Productivity Value" name="prodRate"  value="<?php echo $prodRate; ?>">
                      </div>
