...
CREATE TABLE `historicaldataset` (
  ...
  `munName` varchar(13) DEFAULT NULL,
...
(151, 123123, '121', 'Bokod', 23, 1, 0.0434783),
(152, 2313, 'asdad', 'Baguio', 2, 11, 5.5);
...
CREATE TABLE `user` (
  ...
  `userLocation` varchar(13) NOT NULL,
...
INSERT INTO `user` (`userID`, `userFirstName`, `userLastName`, `userLocation`, `username`, `password`, `userType`) VALUES
(1, '', '', '0', 'test', '$2y$10$SfhYIDtn.iOuCW7zfoFLuuZHX6lja4lF4XA4JqNmpiH/.P3zB8JCa', ''),
(0, 'fdg', 'fdg', '3', 'vfg', '$2y$10$yBKy1H3g50tycJP2uWi1lOkwBhTyB8Q/QOHUvXE981YAQZxd1iVD6', '');
...
--
ALTER TABLE `crops_table`
  MODIFY `cropID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
